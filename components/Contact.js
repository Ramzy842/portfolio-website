...
const Contact = () => {
  return (
    <div className="h-screen relative z-40 " name="contact" id="contact">
      <div className="mx-auto container text-white flex items-center  h-full">
        <div className="max-w-lg mx-auto text-center px-4">
          <h1 className="text-base lg:text-2xl font-medium leading-8 lg:leading-10 mb-16 z-40 ">
            I’m always open to opportunities. Or if you just want to network of
            course you can say hi :)
          </h1>
          <div className="max-w-sm mx-auto flex justify-around z-40">
